...
def pr2_mover(object_list):
    ...
    #for i in (0,len(object_list_param)):
     #   obj_name_list.append(object_list_param[i]['name'])
      #  obj_group_list.append(object_list_param[i]['group'])
    
    # get the arms out of sight
    left_shoulder_pub.publish(1.57)
    right_shoulder_pub.publish(1.57)
...
if __name__ == '__main__':
	...
	pcl_s_filtered_pub = rospy.Publisher("/pcl_s_filtered", PointCloud2, queue_size=1)
	pcl_h_filtered_pub = rospy.Publisher("/pcl_h_filtered", PointCloud2, queue_size=1)
	pcl_l_filtered_pub = rospy.Publisher("/pcl_l_filtered", PointCloud2, queue_size=1)
	left_shoulder_pub = rospy.Publisher('/pr2/left_shoulder_pan_controller/command',
                                   Float64, queue_size=10)
   	right_shoulder_pub = rospy.Publisher('/pr2/right_shoulder_pan_controller/command',
                                   Float64, queue_size=10)
    ...
    # Call them and detected_objects_pub
    # Have them publish to "/object_markers" and "/detected_objects" with 
    # Message Types "Marker" and "DetectedObjectsArray" , respectively
	object_markers_pub = rospy.Publisher("/pcl_object_markers", Marker, queue_size=1)
	detected_objects_pub = rospy.Publisher("/pcl_detected_objects", DetectedObjectsArray, queue_size=1)
